...
def accuracy_data(N_set):
    ...
    DT_BF['True'] = X['True'].nonstat_solve('BF')
...
def accuracy_tables(N_set):
    data_DT_EGM, data_DT_BF, data_compare = accuracy_data(N_set)
...
accuracy_tables(parameters.N_set)
